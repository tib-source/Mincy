...
import { Autocomplete, AutocompleteProps, Text, Avatar, Group, Modal, ModalProps, Tabs, ComboboxStringItem, Button } from "@mantine/core";
import {  IconBrandGithubFilled, IconBrandBitbucketFilled } from "@tabler/icons-react";
        ...
        <Modal {...props}>
            <Tabs variant="outline" defaultValue="github">
                <Tabs.List>
                    ...
                    <Tabs.Tab value="bitbucket" leftSection={<IconBrandBitbucketFilled size={12} />} disabled>
                    BitBucket
                    </Tabs.Tab>
                </Tabs.List>
