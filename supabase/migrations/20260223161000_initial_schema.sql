...
GRANT ALL ON SEQUENCE "public"."PipelineRun_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."PipelineRun_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."PipelineRun_id_seq" TO "service_role";

GRANT ALL ON SEQUENCE "public"."Workflow_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."Workflow_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."Workflow_id_seq" TO "service_role";
